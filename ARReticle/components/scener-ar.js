    ...
    return (
      <ViroNode
        ...
        <ViroImage
          rotation={[-90, 0, 0]}
          visible={this.state.foundPlane}
          source={import('./res/tracking_diffuse_2.png')}
        />
        <ViroImage
          rotation={[-90, 0, 0]}
          visible={!this.state.foundPlane}
          source={import('./res/tracking_diffuse.png')}
        />
      </ViroNode>
    );
  }
      ...
      <ViroNode
        ...
        <ViroNode
          ...
          <Viro3DObject
            ...
            position={[0, 0.5, 0]}
            source={import('./res/emoji_heart_anim/emoji_heart_anim.vrx')}
            resources={[
              import('./res/emoji_heart_anim/emoji_heart.png'),
              import('./res/emoji_heart_anim/emoji_heart_specular.png'),
            ]}
